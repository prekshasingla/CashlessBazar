...
//            }
    ...
    public void sellProduct(final String token) {
//        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest();
        ...
        try {
            ...
            jsonBody.put("Unit",4);
            jsonBody.put("MinimumQuantity",2);
            jsonBody.put("MaximumQuantity",4);
            jsonBody.put("MRP",40.00);
            jsonBody.put("OfferPrice",20.00);
            jsonBody.put("ShippingInfo","Testing Shipping");
            jsonBody.put("LocationInfo","Testing Location Info");
            jsonBody.put("City",2);
            jsonBody.put("Locality",3);

            final String mRequestBody = jsonBody.toString();

            StringRequest stringRequest = new StringRequest(Request.Method.POST, Configuration.urlSellProduct,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            try {
