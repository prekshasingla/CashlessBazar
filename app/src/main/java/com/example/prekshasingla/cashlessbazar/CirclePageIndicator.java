...
public class CirclePageIndicator  extends View implements ViewPager.OnPageChangeListener{
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CirclePageIndicator2, 0, 0);
            circleRadius = (int) a.getDimension(R.styleable.CirclePageIndicator2_indicatorRadius, circleRadius);
            circlePadding = (int) a.getDimension(R.styleable.CirclePageIndicator2_indicatorPadding, circlePadding);
            inactiveColor = a.getColor(R.styleable.CirclePageIndicator2_indicatorInactiveColor, inactiveColor);
            activeColor = a.getColor(R.styleable.CirclePageIndicator2_indicatorActiveColor, activeColor);
            mGravity = a.getInt(R.styleable.CirclePageIndicator2_android_gravity, gravity);
        }
